...
///
/// Anything that isn't a benchmark fast-path (plaintext/json) classifies as
/// `NotFound`. The dispatcher then tries the AOT route table before falling
/// back to a pre-baked 404 — that's how generated /db (and any other generated
/// async route) reaches its handler.
#[inline]
